...
// Build email dynamically so GitHub Pages cannot obfuscate it
var _e = ['info','7feathersretreat','com'].join('').replace('7','@7').replace('com','.com');
  ...
  if (version) {
    ...
    if (version === 'business') {
      navLinks.innerHTML =
        ...
        '<a href="ma' + 'ilto:' + _e + '?subject=Investment%20Inquiry" class="nav-cta">Request Deck</a>';
    } else {
      navLinks.innerHTML =
        ...
        '<a href="ma' + 'ilto:' + _e + '?subject=Partnership%20Inquiry" class="nav-cta">Connect</a>';
    }
